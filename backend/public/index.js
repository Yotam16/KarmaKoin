...
(() => {
    ...
    btnUsers.onclick = () => __awaiter(void 0, void 0, void 0, function* () {
        const users = yield fetchJSON(API_BASE + "users");
        printOutput("Users:\n" + JSON.stringify(users, null, 2));
    });
    const btnMint = document.getElementById("btnMint");
    btnMint.onclick = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    btnTransfer.onclick = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    btnLedger.onclick = () => __awaiter(void 0, void 0, void 0, function* () {
